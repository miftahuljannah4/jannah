...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Absensi Seluruh Karyawan</h4>
    <!-- Contextual Classes -->
    <!-- Responsive Table -->
    <div class="card">
        <div class="card-body">
            <form action="/absensi/printlaporanabsen" target="_blank" method="POST">
                @csrf
                <div class="row">
                ...
                <div class="row mt-3" style="padding-left: 70px">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <button type="submit" name="exportexcel" class="btn rounded-pill btn-icon btn-success">
