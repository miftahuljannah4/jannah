...
<body class="legal">
  ...
  <section class="sheet padding-5mm">
    ...
    <table style="font-family: Arial, Helvetica, sans-serif;vertical-align: top;width:100%">
        <tr >
            <td>
                <img style="padding-left: 20px" src="{{ asset('assets/img/icon/logoo company.png') }}" width="130px" height="130px" alt="" >
            </td>
            <td align=center >

                <p  style="padding-right: 50px; font-size: 15px;valign:top"><b style="font-size: 20px">PT ACE MOLD TECH</b><br>
                Plastic Injection Mold Maker, Specialist in CNC Mill and EDM<br>
                Address: JL. Kawasan Industri Jababeka Tahap 6 Blok D – 3B, Desa Jatireja <br>
                Cikarang Timur – Kab.Bekasi, Jawa Barat Indonesia<br>
                Phone: (021) 8937844    Fax: (021) 8937856</p>
            </td>
        </tr>
    </table>
    ...
    <table class="table">
        <tr>
            ...
            <td style="padding-left: 150px">Divisi</td>
            <td>:</td>
    ...
    <h3 style="margin-top: 70px;font-family: Arial, Helvetica, sans-serif">LAPORAN ABSENSI KARYAWAN</h3>
