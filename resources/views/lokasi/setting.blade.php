            ...
            <div class="card-body">
                <div class="table-responsive text-nowrap mt-3">
                    ...
                    <div class="col-md-5 mt-3">
                        <form action="/lokasi/setstorejam" method="POST">
                            @csrf
                        ...
                        <table class="table" style="font-size: 11px">
                            ...
                            <tbody>
                                    <tr >
                                        ...
                                        <th> <select name="id_jam[]" id="id_jam" class="form-select">
                                            ...
                                            @foreach ($jam_kerja as $data)
                                                <option {{ Request('id_jam') == $data->id_jam ? 'selected' : '' }}
                                    ...
                                    <th>Selasa
                                        ...
                                        <th>
                                            <select name="id_jam[]" id="id_jam" class="form-select">
                                                <option>-pilih-</option>
                                                @foreach ($jam_kerja as $data)
                                                    <option {{ Request('id_jam') == $data->id_jam ? 'selected' : '' }}
                                                        value="{{ $data->id_jam }}">{{ $data->nama_jam }}</option>
                        ...
                        <button class="btn btn-primary col-12 mt-3 mb-3">Simpan</button>
                    </form>
                    </div>
