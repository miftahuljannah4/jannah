...
Route::middleware(['auth:user'])->group(function(){
    ...
    Route::get('/lokasi/jamkerja',[LokasiController::class, 'jamkerja'])->name('jamkerja');
    Route::post('/lokasi/storejam',[LokasiController::class, 'storejam'])->name('storejam');
    Route::post('/lokasi/editjam',[LokasiController::class, 'editjam'])->name('editjam');
    Route::post('/lokasi/{id_jam}/updatejam',[LokasiController::class, 'updatejam'])->name('updatejam');
    Route::post('/lokasi/{id_jam}/hapus',[LokasiController::class,'deletejam'])->name('deletejam');
    Route::get('/lokasi/{nik}/setting',[LokasiController::class,'setting'])->name('setting');
    Route::post('/lokasi/setstorejam',[LokasiController::class, 'setstorejam'])->name('setstorejam');
    Route::post('/lokasi/updatesetting',[LokasiController::class, 'updatesetting'])->name('updatesetting');
});
